...
namespace LowPolyCity
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public List<CarPrefabDetails> Cars { get; set; }
        ...
        public MainPage()
        {
            ...
            {
                new CarPrefabDetails { Name = "Yellow Car", ImagePath = "/Assets/Car_0.png", ResourcePath = "Car_0" },
                new CarPrefabDetails { Name = "Red Car", ImagePath = "/Assets/Car_1.png", ResourcePath = "Car_1" },
                new CarPrefabDetails { Name = "Orange Van", ImagePath = "/Assets/Car_2.png", ResourcePath = "Car_2" },
                new CarPrefabDetails { Name = "Bus", ImagePath = "/Assets/Bus.png", ResourcePath = "Bus" },
                new CarPrefabDetails { Name = "Truck", ImagePath = "/Assets/Truck.png", ResourcePath = "Truck" }
            };
